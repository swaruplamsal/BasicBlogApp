...
from .models import Post, Comment, Category, Tag, PostImage, UserProfile, Reaction
from .serializers import (
    PostSerializer, CommentSerializer, CategorySerializer, TagSerializer,
    UserDetailSerializer, UserProfileUpdateSerializer,ReactionSerializer
)
...
class ReactionViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        # Only allow users to manage their own reactions
