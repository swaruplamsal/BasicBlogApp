...
class Post(models.Model):
    ...
    canonical_url=models.URLField(blank=True,null=True,help_text="Canonical URL if content is republisted")
...
class Reaction(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=["post", "user"], name="unique_reaction_per_user")
        ]
        indexes = [
