...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'author', 'author_id', 'author_username', 'author_avatar',
            'category', 'category_name', 'tags', 'created_at', 
            'updated_at', 'comment_count', 'featured_image', 'featured_image_url',
            'reactions_summary', 'user_reaction','absolute_url', 'canonical_url', 'reading_time'
        ]
