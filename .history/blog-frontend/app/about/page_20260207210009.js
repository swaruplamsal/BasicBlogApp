    ...
    <div className="dark:bg-sky-950">
      ...
      <main style={{ padding: "2rem", maxWidth: "880px", margin: "0 auto" }}>
        ...
        <section style={sectionStyle}>
          ...
          <ul>
            <li>
              Data fetching patterns: server components, client fetching,
              Suspense and loading states
            </li>
            <li>
              Robust forms & validation with good UX (client + server-side
              checks)
            </li>
            <li>
              Styling strategies: Tailwind, component-driven styles and
              responsive layouts
            </li>
            <li>
              Performance: image optimization, caching, code-splitting, and
              Lighthouse improvements
            </li>
            <li>
              Accessibility: semantic HTML, ARIA roles, keyboard navigation and
              testing
            </li>
            <li>
              Testing and quality: unit and integration tests plus E2E (Jest,
              RTL, Playwright)
            </li>
            <li>
              Deployment & CI: build pipelines, preview deploys, and environment
              configuration
            </li>
          </ul>
        </section>
