      ...
      <main style={{ padding: "2rem", maxWidth: "880px", margin: "0 auto" }}>
        ...
        <section style={sectionStyle}>
          ...
          <div className="grid gap-4">
            ...
            <button
              type="button"
              className="w-fit rounded px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-semibold transition-all duration-300 shadow-lg hover:shadow-red-600/50 cursor-pointer"
            >
              Send Message
            </button>
          </div>
