            ...
            <div className="space-y-6">
              ...
              <div>
                <p className="text-lg text-neutral-300 leading-relaxed">
                  Body text uses Inter for exceptional readability and modern appeal. 
                  The letterSpacing is carefully tuned for optimal reading experience 
                  across devices and screen sizes.
                </p>
                <p className="text-sm text-neutral-500 mt-2 font-mono">font-inter, text-lg, leading-relaxed</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="glass-card border-brand-500/20">
              ...
              <ul className="space-y-3 text-sm text-neutral-400">
                ...
                <li>• Inter + Source Serif Pro typography</li>
