    ...
    <footer className="border-t mt-12 py-8 bg-white dark:bg-gray-900">
      <div className="max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <nav className="flex items-center space-x-4">
          <Link
            href="/about"
            "text-sm text-gray-600 hover:text-red-600 transition-colors duration-200 dark:text-gray-300 dark:hover:text-red-400 active:text-red-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-300 rounded"
          >
            About
          </Link>
          <Link
